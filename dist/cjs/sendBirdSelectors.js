...
var topics = require('./topics-c134dcfd.js');
    ...
    return new Promise(function (resolve, reject) {
      ...
      sdk.GroupChannel.getChannel(channelUrl).then(function (channel) {
        channel.leave().then(function () {
          resolve(channel);
          pubsub.publish(topics.LEAVE_CHANNEL, {
            channel: channel
          });
        }).catch(reject);
      }).catch(reject);
...
exports.enterOpenChannel = enterOpenChannel;
exports.exitOpenChannel = exitOpenChannel;
exports.getConnect = getConnect;
exports.getCreateChannel = getCreateChannel;
...
exports.getLeaveChannel = getLeaveChannel;
exports.getOpenChannelDeleteMessage = getOpenChannelDeleteMessage;
exports.getOpenChannelResendFileMessage = getOpenChannelResendFileMessage;
exports.getOpenChannelResendUserMessage = getOpenChannelResendUserMessage;
exports.getOpenChannelSendFileMessage = getOpenChannelSendFileMessage;
exports.getOpenChannelSendUserMessage = getOpenChannelSendUserMessage;
exports.getOpenChannelUpdateUserMessage = getOpenChannelUpdateUserMessage;
