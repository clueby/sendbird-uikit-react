...
var _const$1 = require('../const-e068a55a.js');
var _const = require('../const-6a2e7b51.js');
 ...
 */
var l=objectAssign,n=React__default["default"],aa=require$$2__default["default"];function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}
...
var stream = require$$2__default["default"];
...
var MessageInput = /*#__PURE__*/React__default["default"].forwardRef(function (props, ref) {
  ...
  var _useState5 = React.useState(_rollupPluginBabelHelpers._objectSpread2({}, initialTargetStringInfo)),
  ...
  var setHeight = React.useMemo(function () {
    return function () {
      try {
    ...
    if (isEdit && message !== null && message !== void 0 && message.messageId) {
      ...
      if (isMentionEnabled && (message === null || message === void 0 ? void 0 : (_message$mentionedUse = message.mentionedUsers) === null || _message$mentionedUse === void 0 ? void 0 : _message$mentionedUse.length) > 0 && (message === null || message === void 0 ? void 0 : (_message$mentionedMes = message.mentionedMessageTemplate) === null || _message$mentionedMes === void 0 ? void 0 : _message$mentionedMes.length) > 0) {
        ...
        textField.innerHTML = message === null || message === void 0 ? void 0 : (_message$mentionedMes2 = message.mentionedMessageTemplate) === null || _message$mentionedMes2 === void 0 ? void 0 : _message$mentionedMes2.split(' ').map(function (word) {
          return index.convertWordToStringObj(word, mentionedUsers).map(function (stringObj) {
            var type = stringObj.type,
                value = stringObj.value,
                userId = stringObj.userId;

            if (type === index.StringObjType.mention && mentionedUsers.some(function (user) {
              ...
              return server.renderToString( /*#__PURE__*/React__default["default"].createElement(ui_MentionUserLabel, {
                userId: userId
              }, "".concat(_const.USER_MENTION_TEMP_CHAR).concat(((_mentionedUsers$find = mentionedUsers.find(function (user) {
                return (user === null || user === void 0 ? void 0 : user.userId) === userId;
  ...
  var useMentionedLabelDetection = React.useCallback(function () {
    ...
    if (isMentionEnabled) {
      var newMentionedUserIds = _rollupPluginBabelHelpers._toConsumableArray(textField.getElementsByClassName('sendbird-mention-user-label')).map(function (node) {
        var _node$dataset;
  ...
  React.useEffect(function () {
    if (isMentionEnabled && mentionSelectedUser) {
      ...
      if (targetString && startNodeIndex !== null && startOffsetIndex !== null) {
        ...
        var childNodes = _rollupPluginBabelHelpers._toConsumableArray(textField === null || textField === void 0 ? void 0 : textField.childNodes);
        ...
        var mentionLabel = server.renderToString( /*#__PURE__*/React__default["default"].createElement(ui_MentionUserLabel, {
          userId: mentionSelectedUser === null || mentionSelectedUser === void 0 ? void 0 : mentionSelectedUser.userId
        }, "".concat(_const.USER_MENTION_TEMP_CHAR).concat((mentionSelectedUser === null || mentionSelectedUser === void 0 ? void 0 : mentionSelectedUser.nickname) || stringSet.MENTION_NAME__NO_NAME)));
        var div = document.createElement('div');
        div.innerHTML = mentionLabel;
        var newNodes = [].concat(_rollupPluginBabelHelpers._toConsumableArray(childNodes.slice(0, startNodeIndex)), [frontTextNode, div.childNodes[0], backTextNode], _rollupPluginBabelHelpers._toConsumableArray(childNodes.slice(endNodeIndex + 1)));
        textField.innerHTML = '';
    ...
    if (!isEdit && textField !== null && textField !== void 0 && textField.innerText) {
      ...
      textField.childNodes.forEach(function (node) {
        if (node.nodeType === _const$1.NodeTypes.ElementNode && node.nodeName === _const$1.NodeNames.Span) {
          ...
          mentionTemplate += "".concat(_const.USER_MENTION_TEMP_CHAR, "{").concat(userid, "}");
