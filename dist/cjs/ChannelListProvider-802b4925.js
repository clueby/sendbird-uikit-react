...
var UserProfileContext = require('./UserProfileContext-620fcca0.js');
    ...
    case FETCH_CHANNELS_SUCCESS:
      {
        ...
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
          allChannels: [].concat(_rollupPluginBabelHelpers._toConsumableArray(state.allChannels), _rollupPluginBabelHelpers._toConsumableArray(filteredChannels))
        });
      }
    ...
    case ON_DELIVERY_RECEIPT_UPDATED:
      {
        ...
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
          allChannels: [_channel3].concat(_rollupPluginBabelHelpers._toConsumableArray(state.allChannels.filter(function (_ref7) {
            var url = _ref7.url;
...
//# sourceMappingURL=ChannelListProvider-802b4925.js.map
